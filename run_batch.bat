...
REM set DATA_DIR=G:\EEG\experiment-data\FASTER_170609_Wake41\data\
REM set RESULT_DIR=G:\EEG\experiment-data\FASTER2_170609_Wake41\result\
REM %PYTHON% stage.py -d %DATA_DIR% -r %RESULT_DIR% -p
REM %PYTHON% plot_timeseries.py -d %DATA_DIR% -r %RESULT_DIR% -w 4

REM set DATA_DIR=G:\EEG\experiment-data\FASTER_170707_Wake42\data\
REM set RESULT_DIR=G:\EEG\experiment-data\FASTER2_170707_Wake42\result\
REM %PYTHON% stage.py -d %DATA_DIR% -r %RESULT_DIR% -p
REM %PYTHON% plot_timeseries.py -d %DATA_DIR% -r %RESULT_DIR% -w 4

REM set DATA_DIR=G:\EEG\experiment-data\FASTER_170728_Wake44\data\
REM set RESULT_DIR=G:\EEG\experiment-data\FASTER2_170728_Wake44\result\
REM %PYTHON% stage.py -d %DATA_DIR% -r %RESULT_DIR% -p
REM %PYTHON% plot_timeseries.py -d %DATA_DIR% -r %RESULT_DIR% -w 4
...
REM set DATA_DIR=\\Sss-analysis\FASTER_20181023\FASTER_20190524_Wake98A\data
REM set RESULT_DIR=G:\EEG\experiment-data\FASTER2_20190524_Wake98A\result\
REM %PYTHON% stage.py -d %DATA_DIR% -r %RESULT_DIR% -p
REM %PYTHON% plot_timeseries.py -d %DATA_DIR% -r %RESULT_DIR% -w 4

REM set DATA_DIR=\\Sss-analysis\FASTER_20181023\FASTER_20190621_Wake99A\data
REM set RESULT_DIR=G:\EEG\experiment-data\FASTER2_20190621_Wake99A\result\
REM %PYTHON% stage.py -d %DATA_DIR% -r %RESULT_DIR% -p
REM %PYTHON% plot_timeseries.py -d %DATA_DIR% -r %RESULT_DIR% -w 4
...
set DATA_DIR=G:\EEG\experiment-data\FASTER_20191217_EEG_2019-018\data
set RESULT_DIR=G:\EEG\experiment-data\FASTER2_20191217_EEG_2019-018\result\
%PYTHON% stage.py -d %DATA_DIR% -r %RESULT_DIR% -p
%PYTHON% plot_timeseries.py -d %DATA_DIR% -r %RESULT_DIR% -w 4

set DATA_DIR=G:\EEG\experiment-data\FASTER_20191227_EEG_2019-019\data
set RESULT_DIR=G:\EEG\experiment-data\FASTER2_20191227_EEG_2019-019\result\
%PYTHON% stage.py -d %DATA_DIR% -r %RESULT_DIR% -p
%PYTHON% plot_timeseries.py -d %DATA_DIR% -r %RESULT_DIR% -w 4
