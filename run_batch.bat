...
set DATA_DIR=G:\EEG\experiment-data\FASTER_170609_Wake41\data\
set RESULT_DIR=G:\EEG\experiment-data\FASTER2_170609_Wake41\result\
%PYTHON% stage.py -d %DATA_DIR% -r %RESULT_DIR% -p
%PYTHON% plot_timeseries.py -d %DATA_DIR% -r %RESULT_DIR% -w 4

set DATA_DIR=G:\EEG\experiment-data\FASTER_170707_Wake42\data\
set RESULT_DIR=G:\EEG\experiment-data\FASTER2_170707_Wake42\result\
%PYTHON% stage.py -d %DATA_DIR% -r %RESULT_DIR% -p
%PYTHON% plot_timeseries.py -d %DATA_DIR% -r %RESULT_DIR% -w 4

set DATA_DIR=G:\EEG\experiment-data\FASTER_170728_Wake44\data\
set RESULT_DIR=G:\EEG\experiment-data\FASTER2_170728_Wake44\result\
%PYTHON% stage.py -d %DATA_DIR% -r %RESULT_DIR% -p
%PYTHON% plot_timeseries.py -d %DATA_DIR% -r %RESULT_DIR% -w 4

set DATA_DIR=G:\EEG\experiment-data\FASTER_170908_Wake46\data\
set RESULT_DIR=G:\EEG\experiment-data\FASTER2_170908_Wake46\result\
%PYTHON% stage.py -d %DATA_DIR% -r %RESULT_DIR% -p
%PYTHON% plot_timeseries.py -d %DATA_DIR% -r %RESULT_DIR% -w 4
