...
if __name__ == '__main__':
    ...
    # delta in all epoch
    psd_delta_timeseries_df.to_csv(os.path.join(output_dir, f'power-timeseries_delta.csv'))
    ...
    percentage_psd_delta_timeseries_df.to_csv(os.path.join(output_dir, f'power-timeseries_delta_percentage.csv'))
    ...
    # delta in NREM 
    psd_delta_timeseries_nrem_df.to_csv(os.path.join(output_dir, f'power-timeseries_delta_NREM.csv'))
    ...
    percentage_psd_delta_timeseries_nrem_df.to_csv(os.path.join(output_dir, f'power-timeseries_delta_percentage_NREM.csv'))
    ...
    # total in Wake
    psd_total_timeseries_wake_df.to_csv(os.path.join(output_dir, f'power-timeseries_total_Wake.csv'))
    ...
    # delta in Wake
    psd_delta_timeseries_wake_df.to_csv(os.path.join(output_dir, f'power-timeseries_delta_Wake.csv'))
    ...
    percentage_psd_delta_timeseries_wake_df.to_csv(os.path.join(output_dir, f'power-timeseries_delta_percentage_Wake.csv'))
